    ...
    return (
        <header className="bg-amber-50 border-b border-amber-200 shadow-sm">
            <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                <Link to="/">
                    <h1 className="text-xl font-semibold text-amber-800 cursor-pointer">Mental Health Support</h1>
                </Link>
                ...
                <NavigationMenu>
                    <NavigationMenuList className="flex items-center gap-4 cursor-pointer">
                        ...
                        <NavigationMenuItem className="cursor-pointer">
                            ...
                            <NavigationMenuContent className="bg-white rounded-md shadow-md p-4">
